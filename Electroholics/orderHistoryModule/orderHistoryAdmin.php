        ...
        <?php
            if (isset($_SESSION["accountID"])) {    // if a user is logged in and a session is active
                ...
                if ($accountRole == 1) {    // if the logged in user is an admin, show tabs available only to admin side
                    ...
                    echo "<a href='../orderHistoryModule/orderHistoryAdmin.php' class='active'><b>ALL ORDER HISTORY</b></a>";
    ...
    <main>
        <div class="textBody">
            ...
            <table class="orderHistoryTable">
                <tr>
                    <th colspan="5">All Order History</th>
                </tr>
                ...
                <?php
                    ...
                    while ($row = mysqli_fetch_assoc($results)) {
                        ...
                        // the rows for the customer information, orderID and order datetime
                        echo "<tr>";
                        echo "<td colspan='2' style='padding-left: 10px; padding-top: 5px;'>Ordered By: $username | $userFullName</td>";
                        echo "<td colspan='3'>&nbsp;</td>";
                        echo "</tr>";
                        echo "<tr>";
                        echo "<td colspan='2' style='padding-left: 10px;'>Order ID: $orderID</td>";
                        echo "<td colspan='3'>&nbsp;</td>";
                        echo "</tr>";
                        ...
                        echo "<a href='orderHistoryDetailedAdmin.php?id=$cartID'>View all $numOfItems products in this order</a>";
                        echo "</td>";
                        echo "<td>&nbsp;</td>";
