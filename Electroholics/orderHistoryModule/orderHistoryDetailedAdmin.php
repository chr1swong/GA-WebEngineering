                    ...
                    <table class="orderHistoryTable">
                        <?php
                            ...
                            if (isset($_GET["id"]) && $_GET["id"] != "") {
                                ...
                                $fetchCartQuery = "
                                    ...
                                    cart.cartID,
                                    user_profile.userFullName, user_profile.userContact, user_profile.userAddress,
                                    account.username, account.accountEmail
                                    FROM order_receipt
                        ...
                        <tr class="firstRow">
                            <td colspan="3" style="padding: 10px;">
                                Order ID: <?=$orderID;?><br>
                                Order Date: <?=$orderDatetime;?><br><br>
                        ...
                        <tr class="lastRow">
                            ...
                            <td style="color: red; text-align: center;"><b>RM<?=$paymentAmount;?></b></td>
                        </tr>
                    </table>
