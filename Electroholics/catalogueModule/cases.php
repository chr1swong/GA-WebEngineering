        ...
        <div class="row">
                ...
                <ul>
                    <div id="category-links">
                        ...
                        <div class="categories" id="categories">
                            ...
                            <li><a href="../catalogueModule/cases.php" class="active">Cases and Cooling</a></li>
            ...
            <div class="textBody">
                ...
                <table class="indexTable" id="tableFeaturedProducts">
                    <tr>
                        <th colspan=3 style="font-size: 30px;">Desktop Casing</th>
                    </tr>
                ...
                <table class="indexTable" id="tableFeaturedProducts">
                    <tr>
                        <th colspan=3 style="font-size: 30px;">Cooling</th>
                    </tr>
